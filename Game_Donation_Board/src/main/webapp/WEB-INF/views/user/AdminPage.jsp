        ...
        <div class="col-lg-12">
            <div class="page-content">
             ...
             <div class="item">
              ...
              <c:forEach items="${ProectList}" var="project">
                        <ul style="text-align: center;">
                            <li><img src="${project.project_img}" style="width: 80px; height: 80px; object-fit: cover;" class="templatemo-item"></li>
                            <li><h4>${project.project_title}</h4><span>작성자</span></li>
                            <li><h4>후원 시작일</h4><span>${project.project_start.substring(0, 10)}</span></li>
                            <li><h4>후원 종료일</h4><span>${project.project_end.substring(0, 10)}</span></li>
							<li>
							    <h4>Currently</h4>
							    <span>
							        <c:choose>
                                ...
                                <div class="main-border-button">
									<a href="#" onclick="toggleApprovalStatus(this)" data-project-idx="${project.project_idx}" data-project-status="0">승인 대기</a>
                                </div>
                            </li>    
                        </ul>
				    ...
				    <ul>
				        <c:choose>
				            ...
				            <c:otherwise>
				                <li><a href="AdminPage?page=${page.prevPage}">이전</a></li>
				            </c:otherwise>
				        </c:choose>
				        ...
				        <c:forEach var='idx' begin="${page.min}" end="${page.max}">
				            <li>
								...
								<a href="AdminPage?page=${idx}" style="color: #e75e8d; pointer-events: none;">${idx}</a>
				                    </c:when>
				                    <c:otherwise>
				                        <a href="AdminPage?page=${idx}">${idx}</a>
				                    </c:otherwise>
				                </c:choose>
				            </li>
				        </c:forEach>
				        ...
				        <c:choose>
				            ...
				            <c:otherwise>
				                <li><a href="AdminPage?page=${page.nextPage}">다음</a></li>
				            </c:otherwise>
				        </c:choose>
				    </ul>
				</div>
                    <div class="main-button">
    					<a href="#" onclick="applyApproval()">승인 적용</a>
                    </div>
                </div>
            </div>
        </div>
